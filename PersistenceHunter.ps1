...
# Taken from https://stackoverflow.com/questions/54773305/powershell-how-to-find-out-which-running-services-arent-part-of-os-and-non-ms

#Recommend running as "Get-ServiceInfo | where {$_.CompanyName -ne "Microsoft Corporation"}"

    Write-Output "[*] Checking for services.."
    Write-Output ""
